...
import com.om4a.ct2s.config.Constants;
import com.om4a.ct2s.domain.User;
import com.om4a.ct2s.repository.UserRepository;
import com.om4a.ct2s.security.AuthoritiesConstants;
import com.om4a.ct2s.service.MailService;
import com.om4a.ct2s.service.UserService;
import com.om4a.ct2s.service.dto.AdminUserDTO;
import com.om4a.ct2s.web.rest.errors.BadRequestAlertException;
import com.om4a.ct2s.web.rest.errors.EmailAlreadyUsedException;
import com.om4a.ct2s.web.rest.errors.LoginAlreadyUsedException;
 ...
 * <p>
 * This class accesses the {@link com.om4a.ct2s.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
