...
import { sampleWithRequiredData } from '../fuel.test-samples';
...
describe('Fuel Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'dcf040ff-6816-488d-abb8-4d7820bc9b0a' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '5eb32af1-969a-475f-9f87-eb7f9dc4de39' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.fuels()[0]).toEqual(expect.objectContaining({ id: 'dcf040ff-6816-488d-abb8-4d7820bc9b0a' }));
  });

  describe('trackId', () => {
    it('should forward to fuelService', () => {
      const entity = { id: 'dcf040ff-6816-488d-abb8-4d7820bc9b0a' };
      jest.spyOn(service, 'getFuelIdentifier');
      const id = comp.trackId(entity);
      expect(service.getFuelIdentifier).toHaveBeenCalledWith(entity);
