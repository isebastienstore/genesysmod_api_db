...
import { sampleWithRequiredData } from '../metadata.test-samples';
...
describe('Metadata Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '0eb823cb-eb27-4d44-a3a2-5ae4a3acb025' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '7c8cb81a-eae2-4ec8-91d4-a5a5ec343fa8' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.metadata()[0]).toEqual(expect.objectContaining({ id: '0eb823cb-eb27-4d44-a3a2-5ae4a3acb025' }));
  });
