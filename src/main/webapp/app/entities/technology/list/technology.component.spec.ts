...
import { sampleWithRequiredData } from '../technology.test-samples';
...
describe('Technology Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '0563ae70-8be8-4bb1-8852-4d321adc6f90' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '487ab60d-d042-4abc-9586-ecb3e3b9550d' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.technologies()[0]).toEqual(expect.objectContaining({ id: '0563ae70-8be8-4bb1-8852-4d321adc6f90' }));
  });

  describe('trackId', () => {
    it('should forward to technologyService', () => {
      const entity = { id: '0563ae70-8be8-4bb1-8852-4d321adc6f90' };
      jest.spyOn(service, 'getTechnologyIdentifier');
      const id = comp.trackId(entity);
      expect(service.getTechnologyIdentifier).toHaveBeenCalledWith(entity);
